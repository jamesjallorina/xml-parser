...
{
//////////////////////////////////
//cout<<endl<<"EXIT TRIM SPACES"<<endl;
if (strText.substr(0, 2) == ";;") // don't truncate but remove # from first char
{
	strText = strText.substr(2, strText.size());
	return; 
}
//////////////////////////////////
...
{
//////////////////////////////////
//cout<<endl<<"EXIT NORMALIXZE WHITE SPACES"<<endl;
if (strText.substr(0, 2) == ";;") // don't truncate but remove # from first char
{
	strText = strText.substr(2, strText.size());
	return; 
...
{
//////////////////////////////////
//cout<<endl<<"EXIT NORMALIXZE"<<endl;
if (strText.substr(0, 2) == ";;") // don't truncate but remove # from first char
{
	strText = strText.substr(2, strText.size());
	return; 
